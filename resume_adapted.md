...
- Built modular **Infrastructure-as-Code** with **Terraform** on **Azure** for multi-team cloud environments, powering a self-service provisioning portal (Django, Python) that **cut setup from days to minutes** across dozens of teams.
- Designed and operated an **event-driven observability pipeline** (Azure Event Hub + Datadog) with automated alerting for **real-time incident response** and proactive **monitoring and troubleshooting**.
- **Reduced deployment lead time by 68%** (22 to 7 days) through impact analysis, **root cause analysis**, and a structured countermeasures roadmap.
- Integrated Azure provisioning events with **Kafka** to track platform usage and automation adoption across teams.
...
- Built a document-processing application on GCP (Elasticsearch, neo4j), **increasing search availability by 75%**.
...
- **DevOps Practices**: Automation, system reliability, incident management, **root cause analysis**, runbooks, change management
- **Documentation & Planning**: **Confluence**, Jira, Jira Service Management

---

### Languages

Portuguese (Native) -- English (Fluent) -- German (A2) -- Spanish (B1)
